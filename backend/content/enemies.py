...
MONSTER_DEFINITIONS.update(
    {
        ...
        "cat": MonsterDefinition(
            base_creature_id="cat",
            variant_id="cat",
            display_name="Cat",
            combat_role="cat",
            ai_profile_id="melee_brute",
            ...
            initiative_mod=2,
            passive_perception=13,
            ability_mods=cat_ability_mods,
            size_category="tiny",
            footprint=medium_footprint,
            attacks={
                "scratch": WeaponProfile(
                    id="scratch",
        ...
        "kobold_slinger": MonsterDefinition(
            base_creature_id="kobold",
            variant_id="kobold_slinger",
            display_name="Kobold Slinger",
            combat_role="kobold_slinger",
            ai_profile_id="ranged_skirmisher",
            max_hp=7,
            ac=14,
            speed=30,
            ...
            attack_actions=(
                melee_attack_action("dagger", "Dagger"),
                ranged_attack_action("sling", "Sling"),
            ),
            default_melee_attack_action_id="melee_attack",
            default_ranged_attack_action_id="ranged_attack",
        ),
        ...
        "white_guard_drake": MonsterDefinition(
            base_creature_id="guard_drake",
            variant_id="white_guard_drake",
            display_name="White Guard Drake",
            combat_role="white_guard_drake",
            ai_profile_id="line_holder",
            max_hp=60,
            ac=14,
            speed=30,
            ...
            ability_mods=white_guard_drake_ability_mods,
            size_category="medium",
            footprint=medium_footprint,
            movement_modes=("walk", "burrow", "climb"),
            damage_resistances=("cold",),
            attacks={
                "bite": WeaponProfile(
                    id="bite",
            ...
            tags=("dragon", "drake", "melee"),
            action_ids=("multiattack",),
            attack_actions=(fixed_multiattack_action("multiattack", "Multiattack", ("bite", "tail")),),
            default_melee_attack_action_id="multiattack",
        ),
        ...
        "young_white_dragon_boss": MonsterDefinition(
            base_creature_id="young_white_dragon",
            variant_id="young_white_dragon_boss",
        ...
        "adult_red_dragon": MonsterDefinition(
            ...
            attack_actions=(
                ...
                AttackActionDefinition(
                    action_id="scorching_ray_multiattack",
                    display_name="Multiattack",
                    steps=(
                        AttackStepDefinition(allowed_weapon_ids=("rend",)),
                        AttackStepDefinition(allowed_weapon_ids=("scorching_ray",)),
                        AttackStepDefinition(allowed_weapon_ids=("rend",)),
                    ),
                ),
            ),
...
ENEMY_PRESETS: dict[str, EnemyPresetDefinition] = {
    ...
    "berserker_overrun": EnemyPresetDefinition(
        ...
        units=(
            EnemyPresetUnit("E1", "goblin_raider", GridPosition(x=8, y=4)),
            EnemyPresetUnit("E2", "goblin_raider", GridPosition(x=8, y=6)),
            EnemyPresetUnit("E3", "goblin_raider", GridPosition(x=8, y=8)),
            EnemyPresetUnit("E4", "goblin_raider", GridPosition(x=8, y=10)),
            EnemyPresetUnit("E5", "goblin_raider", GridPosition(x=8, y=12)),
            EnemyPresetUnit("E6", "goblin_raider", GridPosition(x=9, y=5)),
            EnemyPresetUnit("E7", "goblin_raider", GridPosition(x=9, y=7)),
            EnemyPresetUnit("E8", "goblin_raider", GridPosition(x=9, y=9)),
            EnemyPresetUnit("E9", "goblin_raider", GridPosition(x=9, y=11)),
            EnemyPresetUnit("E10", "hobgoblin_captain", GridPosition(x=11, y=5)),
            EnemyPresetUnit("E11", "hobgoblin_captain", GridPosition(x=11, y=10)),
            EnemyPresetUnit("E12", "berserker", GridPosition(x=10, y=7)),
            EnemyPresetUnit("E13", "berserker", GridPosition(x=10, y=9)),
            EnemyPresetUnit("E14", "hobgoblin_archer", GridPosition(x=14, y=4)),
