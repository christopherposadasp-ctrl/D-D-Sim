...
- Wizard is live to level 4 as an Evoker with an Intelligence ASI, `fire_bolt`, `shocking_grasp`, `magic_missile`, `shield`, `burning_hands`, `scorching_ray`, `shatter`, Potent Cantrip, Mage Armor metadata/manual support, and tracked spell access counts
...
| Wizard | Evoker | live to level 4 | combat spellcasting priority |
