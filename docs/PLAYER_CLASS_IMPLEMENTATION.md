...
- Wizard is live at level 5 as an Evoker with level 3 slot metadata, Memorize Spell metadata, Potent Cantrip, Scorching Ray, Shatter, and Mage Armor metadata/manual support.
...
- The default `martial_mixed_party` starts with the level 5 Battle Master Fighter, level 5 Oath of the Ancients Paladin, level 5 ranged Assassin Rogue, and level 5 Evoker Wizard.
