...
- Wizard is live at level 4 as an Evoker with an Intelligence ASI, Potent Cantrip, Scorching Ray, Shatter, and Mage Armor metadata/manual support.
...
- The default `martial_mixed_party` starts with the level 5 Battle Master Fighter, level 5 Oath of the Ancients Paladin, level 5 ranged Assassin Rogue, and level 4 Evoker Wizard.
